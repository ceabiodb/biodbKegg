...
abstract: |
  This vignette shows how to use KEGG databases. In it will learn how to retrieve pathways related to a compound using KEGG databases. How to get a pathways map with a set of enzymes and compounds highlighted on it. How to get new information about KEGG Compound and add it to your existing data frame.
vignette: |
 ...
 * Add new information columns into a data frame that contains a column with KEGG Compound IDs.
...
First we create an instance of the `Biodb` class:
