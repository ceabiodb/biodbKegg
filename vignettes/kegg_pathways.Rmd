...
abstract: |
  This vignette shows the functions of the package that manipulate pathways
  from the KEGG database. In it we will learn how to retrieve pathways related
  to a compound using KEGG databases. How to get a pathways map with a set of
  enzymes and compounds highlighted on it. How to get new information about
  KEGG Compound and add it to your existing data frame.
vignette: |
...
Then we get a connector to the KEGG Compound database [@kanehisa2000_KEGG]:
```{r}
